...
from NSGA2_vrp import load_instance, routeToSubroute, getRouteCost
...
class TestRoute(unittest.TestCase):
    ...
    def test_route(self):
        ...
        sample_individual_subroutes = [[19, 5, 24, 7], [16, 23, 22], [2, 12, 8], [
            20, 25, 21], [18, 11, 15], [1, 14, 17, 6, 4], [13, 10, 3, 9]]
        calculated_subroute = routeToSubroute(
            sample_individual, loaded_instance)
    ...
    def test_subroute_distance(self):
        ...
        sample_individual = [19, 5, 24, 7, 16, 23, 22, 2, 12, 8,
                             20, 25, 21, 18, 11, 15, 1, 14, 17, 6, 4, 13, 10, 3, 9]
        sample_individual_subroutes = routeToSubroute(
            sample_individual, loaded_instance)
        ...
        calculated_distance = getRouteCost(
            first_subroute, loaded_instance, unit_cost=1)
    ...
    def test_route_distance(self):
        ...
        calculated_distance = getRouteCost(
            first_subroute+second_subroute, loaded_instance, unit_cost=1)
